...
class Constant(object):
    ...
    TABLE_CONNECTION_CATS = "connectionCats"
    TABLE_ENUM_API_TYPE = "ENUM_API_TYPE"
    TABLE_ENUM_HCCL_DATA_TYPE = "ENUM_HCCL_DATA_TYPE"
    TABLE_ENUM_HCCL_LINK_TYPE = "ENUM_HCCL_LINK_TYPE"
    TABLE_ENUM_HCCL_RDMA_TYPE = "ENUM_HCCL_RDMA_TYPE"
    TABLE_ENUM_TRANSPORT_TYPE = "ENUM_TRANSPORT_TYPE"
    TABLE_ENUM_MODULE = "ENUM_MODULE"
    TABLE_MSTX_EVENT_TYPE = "MSTX_EVENT_TYPE"
    TABLE_HOST_INFO = "HOST_INFO"
    TABLE_META_DATA = "META_DATA"
    TABLE_NPU_INFO = "NPU_INFO"
    TABLE_OVERLAP_ANALYSIS = "OVERLAP_ANALYSIS"
    TABLE_PYTORCH_API = "PYTORCH_API"
    TABLE_RANK_DEVICE_MAP = "RANK_DEVICE_MAP"
    TABLE_SESSION_TIME_INFO = "SESSION_TIME_INFO"
    TABLE_STATUS_INFO = "status_info"
